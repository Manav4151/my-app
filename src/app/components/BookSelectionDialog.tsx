        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden pr-1">
          ...
          <div className="bg-white rounded-2xl border border-amber-100 p-4 mb-4">
            ...
            <div className="flex gap-3 mt-4">
              <Button onClick={applyBookFilters} disabled={bookLoading} className="bg-amber-600 hover:bg-amber-700">
                Apply Filters
              </Button>
                  ...
                  <table className="w-full divide-y divide-amber-100 table-fixed">
                    <thead className="bg-amber-50">
                      <tr>
                        ...
                        <th className="px-2 py-2 text-left text-xs font-medium text-gray-600 uppercase tracking-wider w-[32%]">
                          Title
                        </th>
                        <th className="px-2 py-2 text-left text-xs font-medium text-gray-600 uppercase tracking-wider w-[15%]">
                          ISBN
                        </th>
                        <th className="px-2 py-2 text-left text-xs font-medium text-gray-600 uppercase tracking-wider w-[20%]">
                          Author
                        </th>
                    ...
                    <tbody className="bg-white divide-y divide-amber-100">
                      {bookData.books.map((book) => (
                        <tr key={book._id} className="hover:bg-amber-50/50">
                          ...
                          <td className="px-2 py-2 text-sm text-gray-700 truncate" title={book.isbn || 'N/A'}>
                            {book.isbn || 'N/A'}
                          </td>
                          <td className="px-2 py-2 text-sm text-gray-700 truncate" title={book.author}>
                            {book.author}
                          </td>
                          <td className="px-2 py-2 text-sm text-gray-700">{book.year}</td>
                          <td className="px-2 py-2 text-sm text-gray-700 truncate" title={book.publisher?.name || 'N/A'}>
